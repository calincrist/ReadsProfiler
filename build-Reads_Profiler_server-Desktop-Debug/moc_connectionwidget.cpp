...
#include "../Reads_Profiler_server/connectionwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ConnectionWidget_t, stringdata) + ofs \
...
void ConnectionWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ConnectionWidget::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ConnectionWidget::tableActivated)) {
                *result = 0;
            }
        }
        {
            typedef void (ConnectionWidget::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ConnectionWidget::metaDataRequested)) {
                *result = 1;
            }
        }
    }
...
void *ConnectionWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ConnectionWidget.stringdata))
